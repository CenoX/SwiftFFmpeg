...
mkdir -p $(dirname "$LIB_XCFRAMEWORK")

xcodebuild -create-xcframework \
  -library $PREFIX/iphoneos-arm64/lib/$LIB_NAME.a -headers $PREFIX/iphoneos-arm64/include/$LIB_NAME \
  -library $PREFIX/iphonesimulator-universal/lib/$LIB_NAME.a -headers $PREFIX/iphonesimulator-arm64/include/$LIB_NAME \
  -library $PREFIX/macosx-universal/lib/$LIB_NAME.a -headers $PREFIX/macosx-arm64/include/$LIB_NAME \
  -output $LIB_XCFRAMEWORK

echo "Successfully created: $LIB_XCFRAMEWORK"
